...
@if ($isProtected)
  <div class="alert alert-secondary small">The <strong>system_admin</strong> role always holds every permission and cannot be changed.</div>
@endif
...
<div class="row g-3">
  @foreach ($groups as $group => $permissions)
    <div class="col-md-6 col-xl-4">
      <div class="card h-100 border"><div class="card-body py-3">
