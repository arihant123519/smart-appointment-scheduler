              ...
              <div class="sas-audience-modal__filters">
                ...
                <div class="row g-2 mb-3">
                  <div class="col-6">
                    ...
                    <input type="number" name="filters[risk_min]" class="form-control form-control-sm sas-audience-filter" data-key="risk_min" min="0" max="100" value="{{ old('filters.risk_min') }}">
                  </div>
                  <div class="col-6">
                    <label class="form-label">Risk max %</label>
                    <input type="number" name="filters[risk_max]" class="form-control form-control-sm sas-audience-filter" data-key="risk_max" min="0" max="100" value="{{ old('filters.risk_max') }}">
                  </div>
                </div>
                <div class="mb-3">
                  <label class="form-label">Exact appointment date</label>
                  <input type="date" name="filters[date]" class="form-control form-control-sm sas-audience-filter" data-key="date" value="{{ old('filters.date') }}">
                </div>
                <div class="row g-2">
                  <div class="col-6">
                    <label class="form-label">Date from</label>
                    <input type="date" name="filters[date_from]" class="form-control form-control-sm sas-audience-filter" data-key="date_from" value="{{ old('filters.date_from') }}">
                  </div>
                  <div class="col-6">
                    <label class="form-label">Date to</label>
                    <input type="date" name="filters[date_to]" class="form-control form-control-sm sas-audience-filter" data-key="date_to" value="{{ old('filters.date_to') }}">
                  </div>
                </div>
              </div>
