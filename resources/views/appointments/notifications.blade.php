  ...
  <div class="row g-3 justify-content-center">
    <div class="col-xl-8">
      ...
      <form method="POST" action="{{ route('appointments.notifications.update') }}">
        ...
        <x-card class="mb-3">
          <x-slot:title><i class="fi fi-rr-refresh me-1"></i> Status-change notifications</x-slot:title>
        ...
        <x-card class="mb-3">
          <x-slot:title>
            <i class="fi fi-rr-clock me-1"></i> Lead-time reminders <span class="text-muted small">(Booked &amp; Confirmed)</span>
          </x-slot:title>
          <x-slot:toolbar>
        ...
        {{-- =================== REPEAT REMINDER =================== --}}
        <x-card class="mb-3">
          <x-slot:title><i class="fi fi-rr-rotate-right me-1"></i> Repeat reminder <span class="text-muted small">(Booked &amp; Confirmed)</span></x-slot:title>
