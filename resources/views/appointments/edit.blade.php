          ...
          <form method="POST" action="{{ route('appointments.update', $appointment) }}">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input type="datetime-local" name="start_at" class="form-control" value="{{ $appointment->start_at->format('Y-m-d\TH:i') }}" required>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="reason" value="{{ $appointment->reason }}" class="form-control">
              </div>
              <div class="col-12">
