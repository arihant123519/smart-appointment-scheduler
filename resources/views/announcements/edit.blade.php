  ...
  <div class="row g-3 justify-content-center">
    <div class="col-xl-6">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="mb-0"><i class="fi fi-rr-edit me-1"></i> Edit announcement</h5>
        <a href="{{ route('announcements.index') }}" class="btn btn-sm btn-outline-secondary"><i class="fi fi-rr-arrow-left me-1"></i> Back</a>
      </div>
        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('announcements.update', $announcement) }}">
            ...
            <div class="mb-3"><label class="form-label">Message</label>
              <textarea name="body" class="form-control" rows="4" required>{{ old('body', $announcement->body) }}</textarea>
            </div>
            ...
            <div class="border rounded p-3 mb-3 bg-light">
              ...
              <div class="row g-2">
                <div class="col-md-7">
                  ...
                  <input type="text" name="wa_template_id" class="form-control form-control-sm" value="{{ old('wa_template_id', $announcement->wa_template_id) }}" placeholder="e.g. 3515c95f-f515-45c1-8b0c-04141e8d858d">
